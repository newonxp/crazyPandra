package resource
{
	...
	public class ResourceManager
	{
		...
		private var _settedResources:Array
		...
		{
			var settedRes:Resource=_settedResources[id]
			if (settedRes)
			{
				return settedRes
			}
		...
		public function set_res(type:String,id:String,data:*):void{
			var res:Resource = new Resource(type,id,data)
			_settedResources[id]=res
		}
		public function set_img(id:String,data:*):void{
			set_res(Resource.type_img,id,data)
		}
		public function set_xml(id:String,data:*):void{
			set_res(Resource.type_xml,id,data)
		}

		public function set_snd(id:String,data:*):void{
			set_res(Resource.type_snd,id,data)
		}

		public function set_fnt(id:String,data:*):void{
			set_res(Resource.type_fnt,id,data)
		}
